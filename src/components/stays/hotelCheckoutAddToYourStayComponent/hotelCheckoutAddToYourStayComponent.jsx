  ...
  return (
    <>
      <div className="AddToYourStayContainer">
        <div className="addToYourStayBoldText text-left">Add to your stay</div>
        <div className="addToYourStayFlexBox">
          <div className="addToYourStayCheckbox">
            ...
            <div>
              <div className="text-left">I'm interested in requesting an airport shuttle</div>
              <div style={{ fontSize: "13px" }} className="text-left">
        ...
        <div className="addToYourStayFlexBox">
          <div className="addToYourStayCheckbox">
            ...
            <div>
              <div className="text-left">I’ll need a flight for my trip</div>
              <div style={{ fontSize: "13px" }} className="text-left">
        ...
        <div className="addToYourStayFlexBox">
          <div className="addToYourStayCheckbox">
            ...
            <div>
              <div className="text-left">I'm interested in renting a car</div>
              <div style={{ fontSize: "13px" }} className="text-left">
        ...
        <div className="addToYourStayFlexBox">
          <div className="addToYourStayCheckbox">
            ...
            <div>
              <div className="text-left">Want to book a taxi or shuttle ride in advance?</div>
              <div style={{ fontSize: "13px" }} className="text-left">
