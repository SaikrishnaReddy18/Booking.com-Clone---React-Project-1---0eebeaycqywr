        ...
        <div>
            ...
            <div className="flex gap-4">
                <div className="flex flex-col gap-2 mt-5 ">
                    <div>
                      {data && <img className="h-40 w-[16rem] ehdhedn" src={data.images[0]}/>}
                    </div>
                    <div>
                        {data && <img className="h-40 w-[16rem] ehdhedn" src={data.images[1]}/>}
                    </div>
                ...
                <div className="mt-5 w-full">
                    <div>
                        {data && <img className="h-80 edjen w-full" src={data.images[2]}/>}
                    </div>
                </div>
            </div>
            ...
            <div className="mt-2 flex gap-2 edjemd">
                {
                    data?.images.map((val)=>{
                        return(
                            <img className="edjeodj h-20 w-40" src={val}/>
                        )
                    })
                }
            </div>
