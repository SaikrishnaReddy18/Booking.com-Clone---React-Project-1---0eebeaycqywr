...
import MyCalender from "./myCalender.jsx";
import { myContext } from "../contextApi/usercontextprovider.jsx";
import MenCountCard from "../stays/menCountCard.jsx";
...
function NavForm(props){
    ...
    function onClickHandler(){
        ...
        navigate(`/hotalList?search=${JSON.stringify(searchCity)}`);
    }
        ...
        <div className="ekmekmke">
            <form method="submit">
                <div className="edjneidue98 lg:flex-col lg:p-0 lg:gap-1 ">
                    ...
                    <input onChange={(e)=>{setSearchCity(e.target.value) }} value={searchCity} className="edjned lg:border-2 outline-none" type="text"
                    ...
                    <input className="edjned lg:border-2 font-semibold outline-none" onClick={()=>setFlag(!flag)} type="text" 
                    ...
                    <input className="edjned lg:border-2 font-semibold outline-none" onClick={handleClick} type="text" value={`${adultCount} adults. ${childrenCount} children. ${roomCount} room`}/>
                    
                    <Button onClick = {onClickHandler} text ="Search" className=" bg-blue-600 hover:bg-blue-800 h-[55px] font-semibold cursor-pointer text-white w-[35%] lg:w-full lg:h-[40px]"/>
                </div>
            </form> 
